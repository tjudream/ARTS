...
* 人格：又称"主运"，是整个姓名的中心点，人一生的命运，均由此人格推断
    * 单姓单名：姓名笔画数总和
    * 单姓复名：姓氏笔画数+名字第一个字的笔画数
    * 复姓单名：姓氏第二个字笔画数+名字的笔画数
    * 复姓复名：姓氏的第二个字笔画数+名字第一个字的笔画数
* 地格：称为"前运"，主管人中年以前的活动力
    * 单名：名的笔画数+1
    * 复名：名字的笔画数总和
* 外格：主管命运之灵力
    * 复姓或复名：姓名的笔画数总和 - 人格数
    * 单姓或单名：姓名的笔画数总和 - 人个数 +1
* 总格：主中年至晚年的命运，又称"后运"
    * 姓名笔画数总和

中国传统易经取名是通过形音义、气势位、五行生克制化、体用、喜用运势盘根、用神补益、节节盘生、挫节盘生、挫中盘生、字五行、音五行、数五行，等十几个方面的作用而应吉凶的
